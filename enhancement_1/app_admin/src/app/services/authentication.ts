...
export class Authentication {
  ...
  // Logour of our application and remove the JWT from Storage
  public logout(): void {
  ...
  // Since that method returns an observable, we subscribe to the
  // result and only process when the Observable condition is satisfied
  // Uncomment the two console.log mesages for additional debug info
  ...
  // Since that method returns an observable, we subscribe to the
  // result and only process when the Observable condition is satisfied
  // Uncomment the two console.log messages for additional debug info
  // Please note: This method is nearly identical to the login method
  // because of the behavior of the API logs a new user in immediately
  // upon registration
